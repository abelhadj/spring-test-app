...
public class WebUtils {
    ...
    public static void addFacesMessage(String msg) {
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(WebUtils.getMessage(msg)));
    }

    public static void addFacesMessage(FacesMessage.Severity severity, String summary) {
        addFacesMessageAsIsWithContext(null, severity, WebUtils.getMessage(summary), FacesContext.getCurrentInstance());
    }
    ...
    public static void addFacesMessageAsIs(FacesMessage.Severity severity, String message) {
        final FacesContext currentInstance = FacesContext.getCurrentInstance();
        addFacesMessageAsIsWithContext(null, severity, message, currentInstance);
    }

    public static void addFacesMessageAsIsWithClientId(String clientId, FacesMessage.Severity severity, String message) {
        final FacesContext currentInstance = FacesContext.getCurrentInstance();
        addFacesMessageAsIsWithContext(clientId, severity, message, currentInstance);
    }

    public static void addFacesMessageAsIsWithContext(FacesMessage.Severity severity, String message, FacesContext ctx) {
        addFacesMessageAsIsWithContext(null, severity, message, ctx);
    }

    public static void addFacesMessageAsIsWithContext(String clientId, FacesMessage.Severity severity, String message, FacesContext ctx) {
